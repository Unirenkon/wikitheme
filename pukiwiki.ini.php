...
$modifierlink = 'http://archeworldwiki.com/';

// Default page name
$defaultpage  = 'ArcheWorld(アーキワールド) Wiki';     // Top / Default page
...
// Default: always fail
$adminpass = '{x-php-crypt}$1$L/JlMwnl$c2MWfm3sJ.70vj0h3CBXk0';
...
// profile: A group of browsers
	...
	// Sample: "DoCoMo/1.0/F501i", "DoCoMo/1.0/N504i/c10/TB/serXXXX" // c以��������衦��
	// Sample: "DoCoMo/2.0 MST_v_SH2101V(c100;TB;W22H12;serXXXX;iccxxxx)" // ()�����������衦��
	array('pattern'=>'#^(DoCoMo)/([0-9\.]+)#',	'profile'=>'keitai'),

	// Vodafone's embedded browser
	// Sample: "J-PHONE/2.0/J-T03"	// 2.0���ġ���#���������� ����#�������㡦
